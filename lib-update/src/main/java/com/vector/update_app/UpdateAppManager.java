...
public class UpdateAppManager {
    ...
    private final boolean mHideDialog;
    private final boolean mShowIgnoreVersion;
    private final boolean mDismissNotificationProgress;
    private final boolean mOnlyWifi;
    //自定义参数
    private final IUpdateDialogFragmentListener mUpdateDialogFragmentListener;
